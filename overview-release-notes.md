...
### 24 October 2025
{: #powervs-vpc-oct24-25}
{: release-note}

Version 10.2.1 of the {{site.data.keyword.powerSysFull}} with VPC landing zone deployable architecture is available
: Version 10.2.1 of the [{{site.data.keyword.powerSys_notm}} with VPC landing zone](https://cloud.ibm.com/catalog/architecture/deploy-arch-ibm-pvs-inf-2dd486c7-b317-4aaa-907b-42671485ad96-global){: external} deployable architecture is available in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}

    - The Standard Variation now correctly supports disabling DNS forwarding without crashing.


### 21 October 2025
{: #powervs-vpc-oct21-25}
{: release-note}

Version 10.2.0 of the {{site.data.keyword.powerSysFull}} with VPC landing zone deployable architecture is available
: Version 10.2.0 of the [{{site.data.keyword.powerSys_notm}} with VPC landing zone](https://cloud.ibm.com/catalog/architecture/deploy-arch-ibm-pvs-inf-2dd486c7-b317-4aaa-907b-42671485ad96-global){: external} deployable architecture is available in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}

    - Remove the monitoring host since it's only relevant for SAP deployments
    - 'Power Virtual Server for SAP HANA' will still support monitoring, as this functionality has been moved to that offering

### 15 October 2025
{: #powervs-vpc-oct15-25}
{: release-note}

Version 10.1.1 of the {{site.data.keyword.powerSysFull}} with VPC landing zone deployable architecture is available
: Version 10.1.1 of the [{{site.data.keyword.powerSys_notm}} with VPC landing zone](https://cloud.ibm.com/catalog/architecture/deploy-arch-ibm-pvs-inf-2dd486c7-b317-4aaa-907b-42671485ad96-global){: external} deployable architecture is available in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}

    - Allow user to define custom VPC subnets
    - It's user responsibility that the subnets don't conflict (4 VPC subnets, 2 PowerVS subnets, vpn client ip pool)
    - Tighter security groups

### 09 October 2025
{: #powervs-vpc-oct09-25}
{: release-note}

Version 10.0.1 of the {{site.data.keyword.powerSysFull}} with VPC landing zone deployable architecture is available
: Version 10.0.1 of the [{{site.data.keyword.powerSys_notm}} with VPC landing zone](https://cloud.ibm.com/catalog/architecture/deploy-arch-ibm-pvs-inf-2dd486c7-b317-4aaa-907b-42671485ad96-global){: external} deployable architecture is available in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}

    - **Breaking Change**:
        - New landing zone version `10.0.1` deprecates **Standard Extend** variation

    - Introducing new variation **Quickstart OpenShift**
        - Leverage {{site.data.keyword.powerSysFull}} with VPC landing zone to deploy a RedHat OpenShift cluster on PowerVS
...
Version 9.0.1 of the {{site.data.keyword.powerSysFull}} with VPC landing zone deployable architecture is available
: Version 9.0.1 of the [{{site.data.keyword.powerSys_notm}} with VPC landing zone](https://cloud.ibm.com/catalog/architecture/deploy-arch-ibm-pvs-inf-2dd486c7-b317-4aaa-907b-42671485ad96-global){: external} deployable architecture is available in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}

    - Quickstart AIX deployments now support DNS configurations.
    - AIX service initialization are now done through ansible-playbook instead of shell scripts.
