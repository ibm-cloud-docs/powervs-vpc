...
# Destroy resources deployed by the OpenShift Deployable Architecture
{: #destroy-openshift}
...
{: #destroy-openshift-cluster-resources-automation}
...
- By using the {{site.data.keyword.cloud_notm}} console:
    1.  Navigate to the **Configurations** inside your **Project**:
        ...
        1.  Select the **Configurations** tab and click on your configuration to open it.

    1.  Set the `destroy_cluster` parameter to true and apply the configuration:
        1.  Inside your confiuration, select **Options** icon ![Options icon](../icons/action-menu-icon.svg > **Edit**
        1.  This will take you to a page where you can edit the input parameters of your configuration.
        1.  Scroll down to locate the **Input** Section and click on **Edit**
        1.  Click on the switch to enable **Optional Inputs**
        1.  In the **Optional Inputs** section, locate `destroy_cluster`and set it to **true**
        1.  Save your configuration and deploy again. This internally triggers an automation that destroys the cluster resources.

    1. Proceed to the next step to destroy the remaining landing zone resources.
...
### Prerequisites
{: #destroy-openshift-resources-manual-prerequisites}
...
### Destroy the Cluster resources
{: #destroy-openshift-cluster-resource-manual}
